...
describe('Component HappyHourAd', () => {
  ...
  it('should render correct props title and countdown', () => {
...
describe('Component HappyHourAd props at specific hours', () => {
  checkDescriptionAtTime('11:57:58', '122');
  checkDescriptionAtTime('11:59:59', '1');
  checkDescriptionAtTime('13:00:00', 23 * 60 * 60 + '');
});
...
describe('Component HappyHourAd when countdown is over', () => {
  checkDescriptionAfterTime('11:57:58', 2, '120');
  checkDescriptionAfterTime('11:59:58', 1, '1');
  checkDescriptionAfterTime('12:00:01', 1, mockProps.promoDescription);
